...
from .configuration_keyboard import P3KeyboardEndEffectorTeleopConfig, P3KeyboardTeleopConfig
...
class P3KeyboardTeleop(Teleoperator):
    """
    Teleop class to use keyboard inputs for control.
    """

    config_class = P3KeyboardTeleopConfig
    name = "parallel3_kb"

    def __init__(self, config: P3KeyboardTeleopConfig):
...
class P3KeyboardEndEffectorTeleop(P3KeyboardTeleop):
    """
    Teleop class to use keyboard inputs for end effector control.
    Designed to be used with the `So100FollowerEndEffector` robot.
    """

    config_class = P3KeyboardEndEffectorTeleopConfig
    name = "parallel3_kb_ee"

    def __init__(self, config: P3KeyboardEndEffectorTeleopConfig):
        super().__init__(config)
        self.config = config
